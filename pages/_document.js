      ...
      return (
        <Html prefix="og: http://ogp.me/ns#" lang={current_lang} className={current_lang}>
          <Head>            
            ...
            <link rel="icon" type="image/png" sizes="32x32" href="/assets/images/ddlvid-small-icon.png?1" />
            <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/ddlvid-small-icon.png?1" />
